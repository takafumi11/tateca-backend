...
INSERT INTO loans(uuid, group_uuid, title, amount, date, payer_id)
VALUES
(@uuid300 := UUID_TO_BIN(UUID(), 1), @uuid200, 'リゴレット', 3600.00, '2024-01-02 03:12:38', @uuid100);
...
INSERT INTO repayment_history(uuid, group_uuid, title, amount, date, payer_id, recipient_user_id)
VALUES
(@uuid500 := UUID_TO_BIN(UUID(), 1), @uuid200, '一部返済', 1000.00, '2024-01-03 03:12:38', @uuid101, @uuid100);